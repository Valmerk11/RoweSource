...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_WING_ATTACK, MOVE_FURY_ATTACK, MOVE_ROCK_SMASH, MOVE_HONE_CLAWS},
    .moves = {MOVE_WING_ATTACK, MOVE_FURY_ATTACK, MOVE_ROCK_SMASH, MOVE_HONE_CLAWS}
    },
	{
    .iv = 255,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_STOMP, MOVE_CONFUSION, MOVE_BULLDOZE, MOVE_AGILITY},
    .moves = {MOVE_STOMP, MOVE_CONFUSION, MOVE_BULLDOZE, MOVE_AGILITY}
    },
    {
    .iv = 255,
    .lvl = 5,
    ...
    .postgameheldItem = ITEM_SITRUS_BERRY,
    .heldItem = ITEM_SITRUS_BERRY,
    .postgamemoves = {MOVE_WING_ATTACK, MOVE_FURY_ATTACK, MOVE_ROCK_TOMB, MOVE_HONE_CLAWS},
    .moves = {MOVE_WING_ATTACK, MOVE_FURY_ATTACK, MOVE_ROCK_TOMB, MOVE_HONE_CLAWS}
    },
	{
    .iv = 255,
    .lvl = 5,
